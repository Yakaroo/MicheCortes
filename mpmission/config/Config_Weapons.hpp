...
class WeaponShops {
    ...
    class cop_basic {
        ...
        items[] = {
			...
			{ "R3F_Famas_surb", "", 5000, 3750, "call life_coplevel >= 4" },
			{ "arifle_SPAR_01_blk_F", "", 5000, 3750, "call life_coplevel >= 4" },
			{ "R3F_Famas_F1", "", 5500, 3750, "call life_coplevel >= 5" },
			{ "hlc_rifle_G36A1", "", 6000, 3750, "call life_coplevel >= 5" },
			{ "hlc_rifle_g3a3ris", "", 8000, 3750, "call life_coplevel >= 6" },
			{ "hlc_rifle_ACR_SBR_black", "", 9000, 15000, "call life_coplevel >= 6" },
			{ "hlc_rifle_vendimus", "", 10000, 15000, "call life_coplevel >= 6" },
			{ "srifle_LRR_F", "", 15000, 3750, "call life_coplevel >= 6" },
			{ "hlc_rifle_awmagnum_BL", "", 30000, 3750, "call life_coplevel >= 6" },
			{ "hlc_rifle_awMagnum_BL_ghillie", "", 30000, 3750, "call life_coplevel >= 6" },
			{ "hlc_rifle_ACR68_full_black", "", 12000, 3750, "call life_coplevel >= 7" },
			{ "srifle_DMR_02_F", "", 20000, 3750, "call life_coplevel >= 7" }
        };
        mags[] = {
