class life_papiere {
	...
	class controls {
		...
		class H_choose_pic4: Life_RscActiveText {
			...
			action = "[] call life_fnc_helikopter;";
		};
		...
		class H_choose_pic6: Life_RscActiveText {
			...
			action = "[] call life_fnc_waffenschein;";
		};
