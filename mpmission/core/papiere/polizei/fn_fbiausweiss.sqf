...
_message = format["<img size='10' color='#FFFFFF' image='core\papiere\polizei\fbi_ausweiss.paa'/><br/><br/><t size='2.5'>%1</t><br/><t size='1'>FBI Department - Tanoa</t>", name player];  
