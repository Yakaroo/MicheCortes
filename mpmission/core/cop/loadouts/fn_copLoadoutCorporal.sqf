...
if (FETCH_CONST(life_coplevel) != 3) exitWith { hint "Du hast nicht den Rang Corporal!" };
...
player addUniform "kenny_police3";
...
/* SCHARFE WAFFE */
player addWeapon "KA_UMP40";
player addMagazine "KA_30Rnd_40SW_FMJ_Mag";
player addMagazine "KA_30Rnd_40SW_FMJ_Mag";
player addMagazine "KA_30Rnd_40SW_FMJ_Mag";
player addMagazine "KA_30Rnd_40SW_FMJ_Mag";
player addMagazine "KA_30Rnd_40SW_FMJ_Mag";
